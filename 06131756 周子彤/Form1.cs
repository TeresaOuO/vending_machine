    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            label5.Text = "本次購買軟性飲料類型,瓶數及總價 ： " + "\r\n\r\n"
             ...
             + "黑松沙士" + StaticNumber.pocarinumber + "瓶計：" + new String(' ', 10) + StaticNumber.heysongnumber * 18 + " 元" + "\r\n"
             + "蘋果西打" + StaticNumber.pocarinumber + "瓶計：" + new String(' ', 10) + StaticNumber.applecidernumber * 40 + " 元" + "\r\n"
             + "烏龍茶" + StaticNumber.pocarinumber + "瓶計：" + new String(' ', 10) + StaticNumber.oolongteanumber * 22 + " 元" + "\r\n"
